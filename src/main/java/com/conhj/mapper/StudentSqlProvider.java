...
import com.conhj.model.StudentExample.Criteria;
import com.conhj.model.StudentExample.Criterion;
...
public class StudentSqlProvider {
    ...
    public String insertSelective(Student record) {
        ...
        if (record.getSname() != null) {
            sql.VALUES("Sname", "#{sname,jdbcType=CHAR}");
        }
        ...
        if (record.getSage() != null) {
            sql.VALUES("Sage", "#{sage,jdbcType=SMALLINT}");
        }
        
        if (record.getSdept() != null) {
            sql.VALUES("Sdept", "#{sdept,jdbcType=CHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getSname() != null) {
            sql.SET("Sname = #{record.sname,jdbcType=CHAR}");
        }
        ...
        if (record.getSage() != null) {
            sql.SET("Sage = #{record.sage,jdbcType=SMALLINT}");
        }
        
        if (record.getSdept() != null) {
            sql.SET("Sdept = #{record.sdept,jdbcType=CHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Student record) {
        ...
        if (record.getSname() != null) {
            sql.SET("Sname = #{sname,jdbcType=CHAR}");
        }
        ...
        if (record.getSage() != null) {
            sql.SET("Sage = #{sage,jdbcType=SMALLINT}");
        }
        
        if (record.getSdept() != null) {
            sql.SET("Sdept = #{sdept,jdbcType=CHAR}");
        }
